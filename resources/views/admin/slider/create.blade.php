                    ...
                    <form action="{{ route('admin.slider.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="button_text" id="button_text" class="mt-1 block w-full" required>
                            </div>
                            <div>
                                <label for="button_url" class="block">Button URL</label>
                                <input type="text" name="button_url" id="button_url" class="mt-1 block w-full" required>
                            </div>
                            <div>
                            ...
                            <div>
                                <button type="submit" class="mt-4 border-black bg-blue-500 text-black py-2 px-4 rounded">Add Slider</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<div class="container">
    ...
    <form action="{{ route('admin.slider.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="url" name="button_url" id="button_url" class="form-control" required>
        </div>
